...
export default function LidarSafetyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">LiDAR Laser Safety Calculator</h1>
      <p className="text-gray-400 mb-8">Analyze pulse energy, PRF-corrected MPE, and NOHD for LiDAR systems (905/1550 nm).</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        ...
        <label className="block"><span className="text-gray-300 text-sm">Pulse Width (ns)</span>
          <input type="number" value={pulseWidth} onChange={e => setPulseWidth(+e.target.value)} step="0.1" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
        ...
        <label className="block"><span className="text-gray-300 text-sm">Scan Range (m)</span>
          <input type="number" value={scanRange} onChange={e => setScanRange(+e.target.value)} className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
      </div>
