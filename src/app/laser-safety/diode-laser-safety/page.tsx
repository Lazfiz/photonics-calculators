...
export default function DiodeLaserSafetyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Diode Laser Safety Calculator</h1>
      <p className="text-gray-400 mb-8">Calculate MPE, NOHD, and OD requirements for diode laser bars/stacks with asymmetric divergence.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        ...
        <label className="block"><span className="text-gray-300 text-sm">Slow Axis Divergence (mrad)</span>
          <input type="number" value={divergenceH} onChange={e => setDivergenceH(+e.target.value)} className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
        <label className="block"><span className="text-gray-300 text-sm">Fast Axis Divergence (mrad)</span>
          <input type="number" value={divergenceV} onChange={e => setDivergenceV(+e.target.value)} className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
      </div>
