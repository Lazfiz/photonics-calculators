...
export default function CornealLimitsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Corneal Exposure Limits</h1>
      <p className="text-gray-400 mb-8">Corneal MPE across UV, visible, and IR spectral regions. Simplified model.</p>
