...
export default function ExposureDurationPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Maximum Safe Exposure Duration</h1>
      <p className="text-gray-400 mb-8">Calculate the maximum safe exposure time for a CW laser beam based on MPE limits.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-4 mb-8">
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Pupil Diameter (mm)</span>
          <input type="number" value={aperture} onChange={e => setAperture(+e.target.value)} min={1} max={7}
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
      </div>
