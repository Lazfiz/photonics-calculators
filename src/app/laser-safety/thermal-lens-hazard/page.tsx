...
export default function ThermalLensHazardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Thermal Lens Hazard</h1>
      <p className="text-gray-400 mb-8">Evaluate thermal lensing risk to protective eyewear and optical components from absorbed laser power.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-3 mb-8">
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Lens Material</span>
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Absorption (fraction)</span>
          <input type="number" value={absorption} onChange={e => setAbsorption(+e.target.value)} min={1e-6} step="any"
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
        <label className="block">
          <span className="text-gray-300 text-sm">Lens Thickness (mm)</span>
          <input type="number" value={thickness} onChange={e => setThickness(+e.target.value)} min={0.1} step="any"
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
      </div>
