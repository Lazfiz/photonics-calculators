...
export default function RetarderPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Waveplate / Retarder</h1>
      <p className="text-gray-400 mb-8">Polarization state transformation by a birefringent waveplate with variable retardance and fast-axis orientation.</p>

      <div className="grid gap-4 sm:grid-cols-3 mb-8">
        <label className="block"><span className="text-gray-300 text-sm">Retardance (°)</span>
          <input type="number" value={retardanceDeg} onChange={e => setRetardanceDeg(+e.target.value)} step="1" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
        <label className="block"><span className="text-gray-300 text-sm">Fast Axis (°)</span>
          <input type="number" value={fastAxisDeg} onChange={e => setFastAxisDeg(+e.target.value)} step="1" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
        <label className="block"><span className="text-gray-300 text-sm">Input Pol. (°)</span>
          <input type="number" value={inputPolDeg} onChange={e => setInputPolDeg(+e.target.value)} step="1" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
      </div>
