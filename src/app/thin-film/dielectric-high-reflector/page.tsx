...
export default function DielectricHRPage() {
  ...
  const [designWl, setDesignWl] = useState(1064);
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Dielectric High Reflector</h1>
      <p className="text-gray-400 mb-8">Quarter-wave dielectric stack HR mirror — stopband width, peak reflectance, and dispersion.</p>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 mb-4">
        ...
        <p className="text-gray-400 text-sm font-mono">R<sub>max</sub> = [(n<sub>H</sub>²ᴺ·n<sub>sub</sub> − n<sub>inc</sub>) / (n<sub>H</sub>²ᴺ·n<sub>sub</sub> + n<sub>inc</sub>)]²</p>
        <p className="text-gray-400 text-sm font-mono">Δλ/λ₀ = (4/π) arcsin[(n<sub>H</sub>−n<sub>L</sub>)/(n<sub>H</sub>+n<sub>L</sub>)]</p>
        <p className="text-gray-400 text-sm font-mono">GDD = d²φ/dω² — group delay dispersion (fs²)</p>
      </div>
