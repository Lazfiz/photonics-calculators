...
export default function QuarterWavePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Quarter-Wave Thickness</h1>
      <p className="text-gray-400 mb-8">Quarter-wave optical thickness (QWOT): nd = λ/4. Optimal AR when n<sub>film</sub> = √(n<sub>inc</sub>·n<sub>sub</sub>).</p>
      ...
      <Plot data={chartData} layout={{ paper_bgcolor: "#111827", plot_bgcolor: "#111827", font: { color: "#9ca3af" }, xaxis: { title: "Wavelength (nm)", gridcolor: "#374151" }, yaxis: { title: "R / T", gridcolor: "#374151" }, margin: { t: 20, b: 40, l: 50, r: 20 }, autosize: true }} className="w-full" style={{ height: 400 }} />
    </div>
  );
}
