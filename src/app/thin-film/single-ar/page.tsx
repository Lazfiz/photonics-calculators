...
export default function SingleARPage() {
  ...
  const chartData = useMemo(() => {
    ...
    return [
      { x: wls, y: Ru, type: "scatter" as const, mode: "lines", name: "Unpolarized", line: { color: "#60a5fa", width: 3 } },
      { x: wls, y: Rs, type: "scatter" as const, mode: "lines", name: "s-pol", line: { color: "#f472b6", dash: "dash" } },
      { x: wls, y: Rp, type: "scatter" as const, mode: "lines", name: "p-pol", line: { color: "#34d399", dash: "dot" } },
    ];
