...
export default function ShortPassPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Short Pass Filter</h1>
      <p className="text-gray-400 mb-8">
        Quarter-wave stack (LH)<sup>N</sup> short-pass filter. Transmits λ &lt; λ<sub>edge</sub>, reflects longer wavelengths.
