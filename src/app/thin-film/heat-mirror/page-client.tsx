  ...
  return (
    <CalculatorShell backHref="/thin-film" backLabel="Thin Film" title="Heat Mirror Design" description="Heat mirrors reflect infrared (thermal radiation) while transmitting visible light.
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        ...
        <label className="block rounded-lg border border-gray-800 bg-gray-900 p-4"><span className="text-sm text-gray-300">Design λ₀ (nm) — IR center</span>
          <input type="number" value={designWl} onChange={e => setDesignWl(+e.target.value)} step="100" className="mt-3 w-full bg-gray-950 border border-gray-700 rounded px-3 py-2 text-white" /></label>
      </div>
