...
export default function HeatMirrorPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Heat Mirror Design</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        <label className="block"><span className="text-gray-300 text-sm">n<sub>H</sub> (high index, e.g. TiO₂)</span>
        ...
        <label className="block"><span className="text-gray-300 text-sm">n<sub>L</sub> (low index, e.g. SiO₂)</span>
        ...
        <label className="block"><span className="text-gray-300 text-sm">Design λ₀ (nm) — IR center</span>
          <input type="number" value={designWl} onChange={e => setDesignWl(+e.target.value)} step="100" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
      </div>
