...
export default function AcquisitionTrackingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6 max-w-5xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-6">Acquisition & Tracking</h1>
      <p className="text-gray-400 mb-6">Probability of acquisition, scan time estimation, and tracking SNR for optical links.</p>
