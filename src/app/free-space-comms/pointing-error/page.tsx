...
export default function PointingErrorPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-6xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Pointing Error Loss</h1>
      <p className="text-gray-400 mb-6">Calculate pointing loss from beam jitter for FSO links.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-5">
          ...
          <Plot
            data={[{ type: "scatter" as const, mode: "lines" as const, x: results.distRange, y: results.lossVsDist, line: { color: "#22c55e", width: 2 } }]}
            layout={{
