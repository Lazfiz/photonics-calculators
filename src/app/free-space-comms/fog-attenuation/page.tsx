...
export default function FogAttenuationPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6 max-w-5xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-6">Fog Attenuation Calculator</h1>

      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 mb-6 text-sm">
        <p className="text-gray-400">Fog is the dominant attenuator for FSO links. Based on the Kim or Kruse model:</p>
