...
export default function PointAheadPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6 max-w-5xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-6">Point-Ahead Angle</h1>
      <p className="text-gray-400 mb-6">Calculate the point-ahead angle for satellite lasercom links due to signal propagation delay.</p>
