...
export default function OpticalAntennaPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6 max-w-5xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-6">Optical Antenna Design</h1>
      <p className="text-gray-400 mb-6">Cassegrain/reflector optical antenna gain, divergence, and beam parameter calculator.</p>
