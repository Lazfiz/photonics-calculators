...
export default function SlowLightPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Slow Light Structures</h1>
      <p className="text-gray-400 mb-8">Group velocity reduction in photonic crystals and EIT media.</p>

      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        <label className="block"><span className="text-gray-300 text-sm">Group Index n_g</span>
          <input type="number" value={nGroup} onChange={e => setNGroup(+e.target.value)} step="any" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
        <label className="block"><span className="text-gray-300 text-sm">Base Index n₀</span>
          <input type="number" value={nBase} onChange={e => setNBase(+e.target.value)} step="any" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
        ...
        <label className="block"><span className="text-gray-300 text-sm">Bandwidth (nm)</span>
        ...
        <label className="block"><span className="text-gray-300 text-sm">Structure Length (mm)</span>
          <input type="number" value={structureLength} onChange={e => setStructureLength(+e.target.value)} step="any" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
      </div>
