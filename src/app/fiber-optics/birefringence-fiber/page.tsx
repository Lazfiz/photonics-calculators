...
export default function BirefringenceCalculator() {
  ...
  const [ellipticity, setEllipticity] = useState<number>(0.98); // b/a ratio
  const [wavelength, setWavelength] = useState<number>(1550); // nm
  const [stressAnisotropy, setStressAnisotropy] = useState<number>(0); // nm
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-2">Fiber Birefringence Calculator</h1>
        <p className="text-gray-400 mb-8">Calculate birefringence, beat length, and PMD for elliptical-core and stress-birefringent fibers</p>
