...
export default function FiberGyroscopePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Fiber Optic Gyroscope (FOG)</h1>
      <p className="text-gray-400 mb-8">Sagnac effect, scale factor, angle random walk, and bias stability for fiber optic gyroscopes.</p>

      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        <label className="block">
          <span className="text-gray-300 text-sm">Coil Diameter (mm)</span>
          <input type="number" value={coilDiameter} onChange={e => setCoilDiameter(+e.target.value)} min={1}
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
        <label className="block">
          <span className="text-gray-300 text-sm">Fiber Length (m)</span>
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Round-trip Losses (dB)</span>
