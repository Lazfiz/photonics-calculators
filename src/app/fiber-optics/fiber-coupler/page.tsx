  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-2">Fiber Coupler Calculator</h1>
        <p className="text-gray-400 mb-8">Design directional and star fiber couplers — power splitting, transfer curves, spectral response</p>
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-8">
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
            <Plot data={transferCurve} layout={layout1} config={{ responsive: true }} className="w-full" />
          </div>
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
            <Plot data={spectralResponse} layout={layout2} config={{ responsive: true }} className="w-full" />
          </div>
        </div>
      </div>
    </div>
