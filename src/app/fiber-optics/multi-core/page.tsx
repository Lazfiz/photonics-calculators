  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-2">Multi-Core Fiber Calculator</h1>
        <p className="text-gray-400 mb-8">Analyze space-division multiplexing with multi-core fiber inter-core crosstalk and capacity</p>
