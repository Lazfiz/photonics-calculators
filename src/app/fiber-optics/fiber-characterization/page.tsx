...
export default function FiberCharacterizationPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Fiber Characterization</h1>
      <p className="text-gray-400 mb-8">Comprehensive fiber parameter calculation: V-number, MFD, effective area, nonlinear coefficient, dispersion, and confinement.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-3 mb-8">
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Core Radius (μm)</span>
          <input type="number" value={coreRadius} onChange={e => setCoreRadius(+e.target.value)} min={1} step="0.1"
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
        <label className="block">
          <span className="text-gray-300 text-sm">Cutoff Wavelength (nm)</span>
