...
export default function LinkBudgetPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Fiber Link Budget</h1>
      <p className="text-gray-400 mb-8">Total optical link loss budget calculator. Power budget vs. accumulated losses.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-3 mb-8">
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Rx Sensitivity (dBm)</span>
