...
export default function MacroBendPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Macro Bend Loss</h1>
      <p className="text-gray-400 mb-8">Detailed macrobending loss calculation for single-mode fibers based on bend radius and wavelength.</p>
