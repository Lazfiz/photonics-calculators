...
export default function FiberOpticSensorPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Fiber Optic Sensors</h1>
      <p className="text-gray-400 mb-8">Calculate sensitivity, resolution, and response for FBG, MZI, Fabry-Pérot, and evanescent fiber sensors.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Strain (με)</span>
          <input type="number" value={strain} onChange={e => setStrain(+e.target.value)} step="any"
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
        {sensorType === "mach_zehnder" && (
          <label className="block">
            <span className="text-gray-300 text-sm">Gauge Length (mm)</span>
        ...
        {sensorType === "fabry_perot" && (
          <label className="block">
            <span className="text-gray-300 text-sm">Cavity Length (μm)</span>
