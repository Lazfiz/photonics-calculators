...
export default function ShotNoisePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Shot Noise</h1>
      <p className="text-gray-400 mb-8">Shot noise: i<sub>shot</sub> = √(2·q·I·Δf). Fundamental noise from quantization of charge.</p>

      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        <label className="block"><span className="text-gray-300 text-sm">Photocurrent (A)</span>
          <input type="number" value={photocurrent} onChange={e => setPhotocurrent(+e.target.value)} step="1e-9" className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" /></label>
