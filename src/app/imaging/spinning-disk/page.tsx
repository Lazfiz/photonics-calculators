...
export default function SpinningDiskPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Spinning Disk Confocal Calculator</h1>
      <p className="text-gray-400 mb-8">Pinhole size, optical sectioning, and frame rate for spinning disk confocal microscopy.</p>
