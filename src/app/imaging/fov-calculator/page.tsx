...
export default function FOVCalculatorPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Field of View Calculator</h1>
      <p className="text-gray-400 mb-8">Calculate sample FOV from sensor dimensions and system magnification.</p>

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        <label className="block">
          <span className="text-gray-300 text-sm">Sensor Width (mm)</span>
          <input type="number" value={sensorW} onChange={e => setSensorW(+e.target.value)} min={1} step="any"
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
        <label className="block">
          <span className="text-gray-300 text-sm">Sensor Height (mm)</span>
