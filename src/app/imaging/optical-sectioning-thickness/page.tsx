...
export default function OpticalSectioningPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Optical Sectioning Thickness Calculator</h1>
      <p className="text-gray-400 mb-8">Compare optical sectioning capability across widefield, confocal, and multiphoton microscopy techniques.</p>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 mb-6">
        ...
        <p className="text-gray-400 text-sm"><code className="text-blue-400">Δz<sub>WF</sub> = nλ / NA²</code></p>
        <p className="text-gray-400 text-sm"><code className="text-green-400">Δz<sub>conf</sub> = 1.4nλ / NA²</code></p>
        <p className="text-gray-400 text-sm"><code className="text-yellow-400">Δz<sub>MP</sub> ≈ 0.7 × 2nλ / NA²</code></p>
      </div>
