...
export default function ClearedTissuePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Cleared Tissue Imaging Calculator</h1>
      <p className="text-gray-400 mb-8">Optical clearing tissue imaging: resolution, transmission, ballistic photon fraction, and RI matching.</p>
