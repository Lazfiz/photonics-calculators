...
export default function ThreePhotonMicroscopyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Three-Photon Microscopy Calculator</h1>
      <p className="text-gray-400 mb-8">Calculate resolution, excitation volume, and depth penetration for three-photon excitation microscopy at 1300+ nm.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Scattering Coeff (cm⁻¹)</span>
          <input type="number" value={scatteringCoeff} onChange={e => setScatteringCoeff(+e.target.value)} min={10} max={500}
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
        <label className="block">
          <span className="text-gray-300 text-sm">Depth (µm)</span>
