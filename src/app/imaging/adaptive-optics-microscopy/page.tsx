...
export default function AdaptiveOpticsMicroscopyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Adaptive Optics in Microscopy</h1>
      <p className="text-gray-400 mb-8">Wavefront correction, Strehl ratio recovery, and resolution improvement for deep-tissue imaging.</p>
