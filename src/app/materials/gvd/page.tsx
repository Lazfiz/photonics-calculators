...
export default function GVDPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Group Velocity Dispersion (GVD)</h1>
      <p className="text-gray-400 mb-8">Calculate d²n/dλ² and β₂ dispersion parameter from Sellmeier coefficients.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        ...
        <label className="block">
          ...
          <input type="number" value={wavelength} onChange={e => setWavelength(+e.target.value)} min={300} max={2500}
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
      </div>
