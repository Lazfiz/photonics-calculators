...
const calculators = [
  ...
  { name: "Cauchy Model", href: "/materials/chromatic-dispersion", desc: "Simplified dispersion model n(λ) = A + B/λ² + C/λ⁴" },
  { name: "Abbe Number", href: "/materials/abbe-number", desc: "Chromatic dispersion measure from refractive indices" },
  ...
  { name: "TIR Critical Angle", href: "/materials/brewster-tir", desc: "Critical angle for total internal reflection" },
  ...
  { name: "Birefringence", href: "/materials/birefringent-crystals", desc: "Ordinary & extraordinary refractive indices" },
