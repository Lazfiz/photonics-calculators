    ...
    <CalculatorShell backHref="/materials" backLabel="Materials" title="Sellmeier Equation" description="n²(λ) = 1 + B₁λ²/(λ²−C₁) + B₂λ²/(λ²−C₂) + B₃λ²/(λ²−C₃)">
      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        ...
        <div>
          ...
          <input type="number" value={wavelength} onChange={e => setWavelength(Number(e.target.value))} className="w-full bg-gray-900 border border-gray-700 rounded p-2 text-white" min={100} max={50000} />
        </div>
      </div>

      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        <ResultCard label={`Refractive index at ${wavelength} nm`} value={n.toFixed(6)} tone="blue" />
