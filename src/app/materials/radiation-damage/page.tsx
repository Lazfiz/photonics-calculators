...
export default function RadiationDamagePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Radiation Damage Effects</h1>
      <p className="text-gray-400 mb-4">Radiation-induced absorption and transmission loss in optical materials</p>
