...
export default function MicrowaveSpectroscopyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Microwave / Rotational Spectroscopy</h1>
      <p className="text-gray-400 mb-8">Pure rotational transitions for molecular structure determination (1–300 GHz).</p>

      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        <label className="block">
          <span className="text-gray-300 text-sm">Molecule Type</span>
      ...
      <div className="bg-gray-900 rounded-lg p-4 mb-6">
        ...
        <p className="text-gray-300 text-sm"><span className="text-blue-400 font-mono">Selection rule:</span> ΔJ = ±1 (dipole-allowed)</p>
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-900 rounded-lg p-4 text-center">
          <p className="text-gray-400 text-xs">B (cm⁻¹)</p>
          <p className="text-xl font-bold text-blue-400">{B.toFixed(4)}</p>
        </div>
        <div className="bg-gray-900 rounded-lg p-4 text-center">
          <p className="text-gray-400 text-xs">B (GHz)</p>
          <p className="text-xl font-bold text-green-400">{B_GHz.toFixed(2)}</p>
        </div>
        <div className="bg-gray-900 rounded-lg p-4 text-center">
          <p className="text-gray-400 text-xs">I (kg·m²)</p>
          <p className="text-xl font-bold text-yellow-400">{I.toExponential(2)}</p>
        </div>
        <div className="bg-gray-900 rounded-lg p-4 text-center">
          <p className="text-gray-400 text-xs">Peak J</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-gray-900 rounded-lg p-4">
          ...
          <Plot data={boltzmannData} layout={{
