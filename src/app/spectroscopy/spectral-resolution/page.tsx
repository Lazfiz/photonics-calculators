...
export default function SpectralResolutionPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-2">Spectral Resolution Calculator</h1>
      <p className="text-gray-400 mb-8">Compare spectral resolution across grating, prism, and Fabry-Pérot spectrometers.</p>

      <div className="grid gap-4 sm:grid-cols-2 mb-8">
        <label className="block">
          <span className="text-gray-300 text-sm">Instrument Type</span>
        ...
        <label className="block">
          <span className="text-gray-300 text-sm">Central Wavelength (nm)</span>
          <input type="number" value={gratingWL} onChange={e => setGratingWL(+e.target.value)} min="100"
            className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
        </label>
        {mode === "grating" && <>
          <label className="block">
            <span className="text-gray-300 text-sm">Groove Density (lines/mm)</span>
          ...
          <label className="block">
            <span className="text-gray-300 text-sm">Slit Width (μm)</span>
            <input type="number" value={slitWidth} onChange={e => setSlitWidth(+e.target.value)} min="1"
              className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
          </label>
          <label className="block">
            <span className="text-gray-300 text-sm">Diffraction Order</span>
        ...
        {mode === "prism" && <>
          ...
          <label className="block">
            <span className="text-gray-300 text-sm">Angular Dispersion (rad/nm)</span>
        ...
        {mode === "fabry-perot" && <>
          <label className="block">
            <span className="text-gray-300 text-sm">Finesse ℱ</span>
            <input type="number" value={finesse} onChange={e => setFinesse(+e.target.value)} min="2" step="1"
              className="mt-1 w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white" />
          </label>
          <label className="block">
            <span className="text-gray-300 text-sm">FSR (nm)</span>
